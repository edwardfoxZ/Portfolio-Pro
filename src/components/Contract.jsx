...
export const Contract = () => {
  return (
    <div id="contact" className="relative max-w-[1100px] mx-auto p-5 py-32">
      <div className="glass my-5 p-10 space-y-10 md:p-32 rounded-xl flex flex-col md:flex-row gap-4 items-center">
        <div className="md:w-1/2 flex flex-col gap-12">
          <div className="flex items-center gap-4">
            <FaLinkedin size={90} className="text-white/50" />
            <div>
              <h2 className="text-white text-2xl font-bold">Contact </h2>
              <h2 className="text-white/50 text-xl">Mobile: xxx</h2>
              <h2 className="text-white/50 text-xl">Email: xxx</h2>
            </div>
          </div>

          <div className="flex items-center gap-4">
            <FaGithub size={90} className="text-white/50" />
            <div>
              <h2 className="text-white text-2xl font-bold">Working Hours </h2>
              <h2 className="text-white/50 text-xl">Mo-Fri: 10am-5pm</h2>
            </div>
          </div>
        </div>
